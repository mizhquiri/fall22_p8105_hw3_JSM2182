...
```
    ...
    ##  1 US1NYAB0001     1     1     1     1     1
    ##  2 US1NYAB0006     1     1     1     1     1
    ##  3 US1NYAB0010     1     1     1     1     1
    ##  4 US1NYAB0016     1     1     1     1     1
    ##  5 US1NYAB0017     1     1     1     1     1
    ##  6 US1NYAB0021     1     1     1     1     1
    ##  7 US1NYAB0022     1     1     1     1     1
    ##  8 US1NYAB0023     1     1     1     1     1
    ##  9 US1NYAB0025     1     1     1     1     1
    ## 10 US1NYAL0002     1     1     1     1     1
    ## # … with 642 more rows
...
data, however, it appears that the missing observeations are evenly
distributed.
...
```
    ...
    ## # A tibble: 2,213,955 × 4
    ## # Groups:   id, year [7,365]
    ##    id           year rank_snow  snow
    ##    <chr>       <int>     <int> <dbl>
    ##  1 US1NYAB0001  2007         1     0
    ##  2 US1NYAB0001  2007         1     0
    ##  3 US1NYAB0001  2007         1     0
    ##  4 US1NYAB0001  2007         1     0
    ##  5 US1NYAB0001  2007         1     0
    ##  6 US1NYAB0001  2007         1     0
    ##  7 US1NYAB0001  2007         1     0
    ##  8 US1NYAB0001  2007         1     0
    ##  9 US1NYAB0001  2007         1     0
    ## 10 US1NYAB0001  2007         1     0
